//! f32-atomic-add abstraction, mirroring `brush-render-bwd`'s
//! `AtomicAddF32`: native `Atomic<f32>::fetch_add` when the device
//! supports it, an `Atomic<u32>` CAS fallback otherwise.
